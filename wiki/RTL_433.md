...
sensors - others are [tire pressure gauges in car
wheels](https://github.com/jboone/tpms), [wireless door bells and car
remote locking
systems](http://adamsblog.aperturelabs.com/2013/03/you-can-ring-my-bell-adventures-in-sub.html).
...
<img src="IMG_20150225_200521.jpg" title="RTL SDR Dongled modified to use an SMA connector" alt="RTL SDR Dongled modified to use an SMA connector" width="800" />
...
Setting the discriminator to 50 as I did above gave lots of junk data
(I'm guessing all the rain gauge data in the capture above is probably
noise that has been incorrectly decoded). Changing the command line to:
